...
/*   Updated: 2013/11/22 18:19:32 by mfontain         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
** author : qperez
** HardCore test : mfontain
** Some Fixes : gabtoubl
**
...
int       uf_test_memccpy(void)
{
  ...
  while (k <= sizeof(ltab))
  {
    ...
    while (i < RANDT)
    {
      ...
      printf("%s - %s\n", ctab, ctab2);
      pouet = memccpy(ctab2, ctab, 'a', (k < sizeof(ctab)) ? k : sizeof(ctab));
      memcpy(ctab3, ctab2, sizeof(ctab));
      //temp2 = ft_memccpy(ctab2, ctab, 'a', (k < sizeof(ctab)) ? k : sizeof(ctab));
      pouet2 = ft_memccpy(ctab2, ctab, 'a', (k < sizeof(ctab)) ? k : sizeof(ctab));
      printf("%s - %s\n", pouet, pouet2);
...
int         main(int argc, const char **argv)
{
  ...
  //uf_add_test(test, "memset", uf_test_memset);//OK
  //uf_add_test(test, "bzero", uf_test_bzero);//OK
  //uf_add_test(test, "memcpy", uf_test_memcpy);//OK
  uf_add_test(test, "memccpy", uf_test_memccpy);//FAIL
  uf_add_test(test, "memmove", uf_test_memmove);//a tester
  uf_add_test(test, "memchr", uf_test_memchr);//FAIL
  uf_add_test(test, "memcmp", uf_test_memcmp);//FAIL
  uf_add_test(test, "strlen", uf_test_strlen);//OK
  uf_add_test(test, "strdup", uf_test_strdup);//OK
  uf_add_test(test, "strcpy", uf_test_strcpy);//OK
  uf_add_test(test, "strncpy", uf_test_strncpy);//OK
  uf_add_test(test, "strcat", uf_test_strcat);//OK
  uf_add_test(test, "strncat", uf_test_strncat);//a tester
  uf_add_test(test, "strlcat", uf_test_strlcat);//a tester
  uf_add_test(test, "strchr", uf_test_strchr);//OK
  uf_add_test(test, "strrchr", uf_test_strrchr);//OK
  uf_add_test(test, "strstr", uf_test_strstr);//OK
  uf_add_test(test, "strnstr", uf_test_strnstr);//a tester
  uf_add_test(test, "strcmp", uf_test_strcmp);//OK
  uf_add_test(test, "strncmp", uf_test_strncmp);//ok
 // uf_add_test(test, "atoi", uf_test_atoi);
  uf_add_test(test, "alpha", uf_test_isalpha);//ok
  uf_add_test(test, "digit", uf_test_isdigit);//ok
  uf_add_test(test, "alnum", uf_test_isalnum);//ok
  uf_add_test(test, "isascii", uf_test_isascii);//OK
  uf_add_test(test, "isprint", uf_test_isprint);//ok
  uf_add_test(test, "toupper", uf_test_toupper);//ok
  uf_add_test(test, "tolower", uf_test_tolower);//ok
//  uf_add_test(test, "memalloc_del", uf_test_memalloc_and_del);//FAIL
//  uf_add_test(test, "strnew", uf_test_strnew);//FAIL
//  uf_add_test(test, "strdel", uf_test_strdel);//FAIL
//  uf_add_test(test, "strclr", uf_test_strclr);//FAIL
//  uf_add_test(test, "striter", uf_test_striter);//FAIL
//  uf_add_test(test, "striteri", uf_test_striteri);//FAIL
//  uf_add_test(test, "strmap", uf_test_strmap);//a tester
//  uf_add_test(test, "strmapi", uf_test_strmapi);// a tester
//  uf_add_test(test, "strequ", uf_test_strequ);//FAIL
//  uf_add_test(test, "strnequ", uf_test_strnequ);//a tester
//  uf_add_test(test, "strsub", uf_test_strsub);//a tester
//  uf_add_test(test, "strjoin", uf_test_strjoin);//a tester
//  uf_add_test(test, "strsplit", uf_test_strsplit);//a tester
...
/*
  char * str;
  str = "Ceci est une chaine inutile";

  printf("%p\n", memchr(str, 'u', ft_strlen(str)));
  printf("%p\n", ft_memchr(str, 'u', ft_strlen(str)));
  printf("%p\n", memchr(str, 'z', ft_strlen(str)));
  printf("%p\n", ft_memchr(str, 'z', ft_strlen(str)));
  printf("%p\n", memchr(str, 'u', 0));
  printf("%p\n", ft_memchr(str, 'u', 0));*/
  return (0);
}
